  ...
  app.innerHTML = `
    ...
    ${section('⚽ Running a live match', `
      <ul class="stack" style="margin:0; padding-left:18px;">
        ...
        <li>A live <strong>Formation</strong> pitch sits at the top of the screen, matching your lineup as it actually stands. Drag any on-field player to another spot to reposition them (or swap two players' positions), or drag a bench player straight onto the pitch — drop them on an empty spot to bring them on, or onto an occupied one to substitute. The formation picker above it works mid-match too: switching shapes moves everyone's dot to the new layout without touching who's actually on the field.</li>
