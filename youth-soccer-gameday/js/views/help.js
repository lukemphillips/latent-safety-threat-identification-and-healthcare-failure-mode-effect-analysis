  ...
  app.innerHTML = `
    ...
    ${section('⚽ Running a live match', `
      <ul class="stack" style="margin:0; padding-left:18px;">
        ...
        <li>A live <strong>Formation</strong> pitch sits at the top of the screen, matching your lineup as it actually stands. Tap any on-field player on it to open a quick "Substitute" list of who's available on the bench — pick one and they're straight on, no need to scroll down to the bench section first. An <strong>empty spot</strong> on the pitch (shown as a dashed circle with a "+") works the same way — tap it to bring someone straight into that exact position, no swap needed. Tap the empty goalkeeper spot and it opens the usual Assign Goalkeeper dialog instead, so stint tracking stays correct. The <strong>Formation</strong> picker above it works mid-match too: switching shapes moves everyone's dot to the new layout without touching who's actually on the field.</li>
